...
public class ScrollGui1Menu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public ScrollGui1Menu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(EjrModMenus.SCROLL_GUI_1.get(), id);
