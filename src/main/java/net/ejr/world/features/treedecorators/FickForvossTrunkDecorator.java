...
public class FickForvossTrunkDecorator extends TrunkVineDecorator {
	public static Codec<FickForvossTrunkDecorator> CODEC = Codec.unit(FickForvossTrunkDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(ForgeRegistries.Keys.TREE_DECORATOR_TYPES, registerHelper -> registerHelper.register("fick_forvoss_tree_trunk_decorator", DECORATOR_TYPE));
	}
