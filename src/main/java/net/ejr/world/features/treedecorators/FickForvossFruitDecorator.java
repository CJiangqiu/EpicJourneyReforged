...
public class FickForvossFruitDecorator extends CocoaDecorator {
	public static Codec<FickForvossFruitDecorator> CODEC = Codec.unit(FickForvossFruitDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(ForgeRegistries.Keys.TREE_DECORATOR_TYPES, registerHelper -> registerHelper.register("fick_forvoss_tree_fruit_decorator", DECORATOR_TYPE));
	}

	public FickForvossFruitDecorator() {
		super(0.2f);
	}
