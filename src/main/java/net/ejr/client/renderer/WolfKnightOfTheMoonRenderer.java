...
public class WolfKnightOfTheMoonRenderer extends GeoEntityRenderer<WolfKnightOfTheMoonEntity> {
	...
	@Override
	public void preRender(PoseStack poseStack, WolfKnightOfTheMoonEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red,
